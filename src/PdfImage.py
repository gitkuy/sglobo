...
class PdfImage(Flowable):
    ...
    source: https://stackoverflow.com/users/4497962/skidzo
            https://stackoverflow.com/questions/3448365/pdf-image-in-pdf-document-using-reportlab-python/41808475#41808475
    """
